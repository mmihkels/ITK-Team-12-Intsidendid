...
privileged aspect ObjektIntsidendi_Roo_ToString {
    
    public String ObjektIntsidendi.toString() {
        ...
        sb.append("ObjektIntsidendisId: ").append(getObjektIntsidendisId()).append(", ");
